...
class PlainMultiHeadAttention(nn.Module):
    def __init__(
        ...
        self.attn_proj = nn.Linear(embed_dim, embed_dim, bias=bias)
    ...
    def set_parameters(self, torch_tgt_module):
        ...
        self.attn_proj.weight.data = torch_tgt_module.out_proj.weight.data
        self.attn_proj.bias.data = torch_tgt_module.out_proj.bias.data
