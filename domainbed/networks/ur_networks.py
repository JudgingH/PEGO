...
class URResNet(torch.nn.Module):
    ...
    def __init__(self, input_shape, hparams, preserve_readout=False, freeze=None, feat_layers=None, pre_backbone=None):
        ...
        if pre_backbone:
            from ..networks.backbones import clip_imageencoder
            self.network = clip_imageencoder("ViT-B/16")
